...
\newcommand{\md}{ {\rm d} }
\newcommand{\ACER}{ {\rm ACER} }
\newcommand{\ACE}{{\rm ACE}}
\newcommand{\T}{ {\rm T} }
\newcommand{\red}[1]{{\leavevmode\color{red}{#1}}}
\newcommand{\MISE}{ {\rm MISE} }
\newcommand{\hJ}{{\hat{\mathbb{J}}_{\hat{\mathbb{F}},\hat{\bm{H}}}}}
\newcommand{\J}{{\mathbb{J}}_{\mathbb{F},\bm{H}}}
\newcommand{\hF}{\hat{\mathbb{F}}}
\newcommand{\hH}{{\hat{\bm{H}}}}
\newcommand{\hL}{{\hat{\bm{L}}}}
\newcommand{\bL}{{\bm{L}}}
...
\begin{figure}[H]
  \centering
  \subfigure[ACA]{
    \includegraphics[width=0.45\textwidth]{Figure/intensityplot_ACA.png}
  }
  \subfigure[CA3]{
    \includegraphics[width=0.45\textwidth]{Figure/intensityplot_CA3.png}
  }
  \subfigure[DG]{
    \includegraphics[width=0.45\textwidth]{Figure/intensityplot_DG.png}
  }
  \subfigure[LS]{
    \includegraphics[width=0.45\textwidth]{Figure/intensityplot_LS.png}
  }
